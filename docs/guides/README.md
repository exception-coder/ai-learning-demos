...
> 本目录包含所有 Spring AI 相关的学习指南和技术文档
...
1. **按需阅读**: 根据自己的学习阶段选择合适的文档
2. **对比学习**: 对比旧实现和新实现，理解 Spring AI 的优势
3. **实践验证**: 边阅读边运行代码，加深理解
4. **记录疑问**: 遇到问题记录到 `learning-journal.md`
5. **循序渐进**: 不要跳过基础概念，扎实学习
